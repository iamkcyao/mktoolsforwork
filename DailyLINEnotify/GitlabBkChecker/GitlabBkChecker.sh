...
# 指定帳戶 , 至 IAM 頁面查詢
serviceAccount="930195980486-compute@developer.gserviceaccount.com"
# 指定ProjectName
projectName="gcp-global-api"
# 指定VM地區
regionName="asia-east1"
zoneName="asia-east1-b"
# 指定subnets
subnetsName="subnet-global-api-tw1"
...
do
	...
	#TodayNasFileName=$(ssh datachecker@192.168.120.252 "find ${folderpath}/* -newermt "${nowdate3}"")
