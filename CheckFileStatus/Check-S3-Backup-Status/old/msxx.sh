#備份相關資訊
iamaccount="336841150582-larry"
product_folder="ms-s3backup"
...
then
    echo "${FolderName["$i"]} 今日新增 ${FileCount} 個檔案"
